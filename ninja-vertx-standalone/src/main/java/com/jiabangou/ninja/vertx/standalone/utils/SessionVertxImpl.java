 ...
 */
public class SessionVertxImpl implements Session {
    private final static Logger logger = LoggerFactory.getLogger(SessionVertxImpl.class);
    ...
    @Inject
    public SessionVertxImpl(Crypto crypto, CookieEncryption encryption, NinjaProperties ninjaProperties, Clock clock) {
